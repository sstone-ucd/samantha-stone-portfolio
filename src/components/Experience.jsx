...
const ExperienceCard = ({experience}) =>(
  <VerticalTimelineElement
    contentStyle={{background: '#ffffff', color:'#3C3C3C'}}
    contentArrowStyle={{borderRight: '7px solid #3C3C3C'}}
    date={experience.date}
    iconStyle={{background: experience.iconBg, border:'2px solid #3C3C3c'}}
    icon={
  ...
  >
    <div>
      <h3 className="text-chilli text-[24px] font-bold">{experience.title}</h3>
    ...
    <>
      ...
      <div className="mt-20 flex flex-col">
        <VerticalTimeline
          ...
          lineColor='#3C3C3C' 
        >
          {/*Loop over experiences from constants */}
